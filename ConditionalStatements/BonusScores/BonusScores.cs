    ...
    class BonusScores
    {
        static void Main()
        {
            ...
            switch (score)
            {
                ...
                case 2:
                case 3:
                    Console.WriteLine("Your score with the applied bonus is {0}", score * 10);
                    break;
                case 4:
                case 5:
                case 6:
                    Console.WriteLine("Your score with the applied bonus is {0}", score * 100);
                    break;
                case 7:
                case 8:
                case 9:
                    Console.WriteLine("Your score with the applied bonus is {0}", score * 1000);
                    break;
                default:
